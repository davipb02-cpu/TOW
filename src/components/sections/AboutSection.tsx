  ...
  return (
    <section id="about" className="py-24 px-6 max-w-[1440px] mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
        <div className="sticky top-24 md:top-32 self-start">
          ...
          <div
            className="w-64 h-64 md:w-full md:aspect-square bg-cover bg-center rounded-lg grayscale hover:grayscale-0 transition-all duration-700"
            style={{
